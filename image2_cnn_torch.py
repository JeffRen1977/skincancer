...
160x160 input, ReLU, no dropout.

Run training:  python image2_cnn_torch.py
Run analysis:  python image2_cnn_torch.py --analyze [--model saves/image2_cnn_model.pth] [--output saves/class_accuracy_image2_cnn.png]
"""
import torch
...
# -----------------------------------------------------------------------------
# Class accuracy analysis (image2_cnn model only)
# -----------------------------------------------------------------------------
...
def _preprocess_image(image_path):
    """Load and preprocess image for image2_cnn (160x160, [0,1] range)."""
...
def analyze_class_accuracy(model_path="saves/image2_cnn_model.pth", data_dir=None,
                           max_images_per_class=50, output_path="saves/class_accuracy_image2_cnn.png",
                           device=None):
    """Analyze per-class accuracy for the image2_cnn model."""
    if data_dir is None:
    ...
    print("\n" + "=" * 80)
    print("CLASS-WISE ACCURACY ANALYSIS (Image2 CNN)")
    print("=" * 80)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Image2 CNN: train or analyze class accuracy")
    parser.add_argument("--analyze", action="store_true", help="Run class accuracy analysis instead of training")
    parser.add_argument("--model", default="saves/image2_cnn_model.pth", help="Model path (for --analyze)")
    ...
    parser.add_argument("--output", default="saves/class_accuracy_image2_cnn.png", help="Output plot path (for --analyze)")
